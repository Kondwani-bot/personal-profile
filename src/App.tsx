  ...
  return (
    <div className="min-h-screen relative flex flex-col bg-slate-50/90 text-slate-800 font-sans selection:bg-purple-500/20 selection:text-purple-900">
      ...
      <main className="relative z-10 flex-1 pt-20 sm:pt-22 flex flex-col">
        ...
        {viewMode === 'resume-pdf' && (
          <div className="max-w-5xl mx-auto px-3 sm:px-6 py-4 flex-1 w-full min-h-[calc(100vh-6rem)] animate-in fade-in duration-300">
      ...
      {viewMode === '2d-dashboard' && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-30 p-3 rounded-full bg-purple-700 hover:bg-purple-800 text-white shadow-lg transition-all hover:scale-110 cursor-pointer hidden md:flex items-center justify-center border border-purple-500/50"
          title="Scroll to top"
        >
      ...
      <footer className="relative z-10 glass-panel-subtle border-t border-purple-100 py-6 px-4 text-center text-xs text-slate-600 mt-auto bg-white/80">
