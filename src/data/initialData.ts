...
export const INITIAL_PROFILE: ProfileData = {
  ...
  projects: [
    {
      id: "proj-aura",
      title: "Aura Executive: Digital Chief of Staff",
      shortDescription: "High-caliber executive AI assistant powered by Google Gemini SDK, featuring encrypted context document vaults, dynamic calendar tool scheduling, and nuanced executive email drafting.",
      fullDescription: "Architected Aura, an executive-grade digital Chief of Staff tailored for high-consequence leaders. Leverages Google Gemini models with structured function calling to orchestrate calendar schedules, query encrypted personal context document vaults, and draft nuanced executive communications within a bespoke luxury dark-mode slate & gold interface.",
      category: "ai-ml",
      tags: ["Google Gemini SDK", "React", "AI Agent", "Function Calling", "Document Vault", "Tailwind CSS", "Netlify"],
      githubUrl: "https://github.com/Kondwani-bot",
      liveUrl: "https://aura-executive-assistant.netlify.app/",
      featured: true,
      metrics: "Live AI Chief of Staff",
    ...
    {
      id: "proj-zambia-internship",
      title: "Zambia National Internship & Industrial Placement Platform",
      shortDescription: "Nationwide digital talent pipeline connecting Zambian university scholars (UNZA, CBU, Mulungushi) with national regulatory authorities and industrial enterprises (ZICTA, Airtel, Mopani).",
      fullDescription: "Designed and deployed a centralized national internship ecosystem bridging academia and industry across Zambia. Implemented tripartite role dashboards (Student, Employer, and Ministry/Admin), automated application status tracking, credential validation, skill-based opportunity matching, and national placement analytics.",
      category: "fullstack",
      tags: ["React", "TypeScript", "National Platform", "Role Dashboards", "UNZA / CBU / ZICTA", "Tailwind CSS", "Netlify"],
      githubUrl: "https://github.com/Kondwani-bot",
      liveUrl: "https://zambia-national-internship-platform.netlify.app/",
      featured: true,
      metrics: "Nationwide Talent Platform",
    ...
    {
      id: "proj-ecom30",
      title: "NexusMart: AI-Powered Next-Gen E-Commerce",
      shortDescription: "Intelligent e-commerce storefront with integrated conversational AI shopping assistance, multi-facet product filtering, live cart management, and seamless checkout flows.",
      fullDescription: "Engineered NexusMart, a modern digital commerce application powered by Gemini AI shopping discovery. Implements responsive product catalogs (artisan stationery, executive notebooks, studio tools), active shopping cart state, price and category filters, and an optimized mobile-first checkout experience.",
      category: "fullstack",
      tags: ["React", "Gemini AI", "E-Commerce", "Cart State", "Tailwind CSS", "TypeScript", "Netlify"],
      githubUrl: "https://github.com/Kondwani-bot",
      liveUrl: "https://ecom30.netlify.app/",
      featured: true,
      metrics: "Live AI E-Commerce Store",
    ...
    {
      id: "proj-hive-studio",
      title: "Hive Studio: Creative Marketing Agency & Interactive Voice AI",
      shortDescription: "Modern creative marketing agency web application featuring an integrated ElevenLabs conversational AI voice agent, case study showcases, and interactive consultation funnel.",
      fullDescription: "Developed the flagship web platform for Hive Studio, combining high-impact digital marketing showcases with interactive AI voice engagement. Integrated the ElevenLabs Conversational AI voice agent widget for real-time visitor consultations, brand portfolio carousels, responsive service tier selectors, and inbound inquiry pipelines.",
      category: "fullstack",
      tags: ["React", "ElevenLabs AI Voice", "Conversational AI", "Creative Agency", "Tailwind CSS", "TypeScript", "Netlify"],
      githubUrl: "https://github.com/Kondwani-bot",
      liveUrl: "https://hive-studio-agency.netlify.app/",
      featured: true,
      metrics: "Live Agency & Voice AI",
